"""
Clean DBSCAN binning implementation for V2 architecture.

This module provides DBSCANBinningV2 that inherits from IntervalBinningBaseV2.
...
class DBSCANBinningV2(IntervalBinningBaseV2):
    """DBSCAN clustering-based binning implementation using V2 architecture.
