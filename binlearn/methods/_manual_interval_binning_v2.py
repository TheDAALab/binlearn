"""
Clean Manual Interval binning implementation for V2 architecture.

This module provides ManualIntervalBinningV2 that inherits from IntervalBinningBaseV2.
...
class ManualIntervalBinningV2(IntervalBinningBaseV2):
    """Manual interval binning implementation using V2 architecture.
    ...
    def __init__(
        ...
        if bin_edges is None:
            raise ConfigurationError(
                "bin_edges must be provided for ManualIntervalBinningV2",
                suggestions=[
    ...
    def _validate_params(self) -> None:
        ...
        if not self.bin_edges:  # Empty dict
            raise ConfigurationError(
                "bin_edges cannot be empty for ManualIntervalBinningV2",
                suggestions=[
