"""
Clean Chi-square binning implementation for V2 architecture.

This module provides Chi2BinningV2 that inherits from SupervisedBinningBaseV2.
...
class Chi2BinningV2(SupervisedBinningBaseV2):
    """Chi-square binning implementation using V2 architecture.
    ...
    def _calculate_bins(
        ...
        # Extract the single target column (guaranteed to have shape (n_samples, 1) by SupervisedBinningBaseV2)
    ...
    def _calculate_chi2_bins(
        ...
        Args:
            ...
            y_col: Target data - 1D array (may have been filtered by SupervisedBinningBaseV2)
            col_id: Column identifier
        ...
        """
        # The feature data (x_col) is already preprocessed by IntervalBinningBaseV2
        # The target data (y_col) has been handled by SupervisedBinningBaseV2
