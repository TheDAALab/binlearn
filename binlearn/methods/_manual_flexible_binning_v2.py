"""
Clean Manual Flexible binning implementation for V2 architecture.

This module provides ManualFlexibleBinningV2 that inherits from FlexibleBinningBaseV2.
...
class ManualFlexibleBinningV2(FlexibleBinningBaseV2):
    """Manual flexible binning implementation using V2 architecture.
    ...
    def __init__(
        ...
        if bin_spec is None:
            raise ConfigurationError(
                "bin_spec must be provided for ManualFlexibleBinningV2",
                suggestions=[
    ...
    def _validate_params(self) -> None:
        ...
        if self.bin_spec is None or len(self.bin_spec) == 0:
            raise ConfigurationError(
                "bin_spec must be provided and non-empty for ManualFlexibleBinningV2",
                suggestions=[
    ...
    def _calculate_flexible_bins(
        ...
        # The V2 architecture uses feature_N names internally, but users provide 0, 1, etc.
