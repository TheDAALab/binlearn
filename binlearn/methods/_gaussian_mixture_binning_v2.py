"""
Clean Gaussian Mixture binning implementation for V2 architecture.

This module provides GaussianMixtureBinningV2 that inherits from IntervalBinningBaseV2.
...
class GaussianMixtureBinningV2(IntervalBinningBaseV2):
    """Gaussian Mixture Model clustering-based binning implementation using V2 architecture.
