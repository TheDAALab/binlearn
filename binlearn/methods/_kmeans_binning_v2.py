"""
Clean K-means binning implementation for V2 architecture.

This module provides KMeansBinningV2 that inherits from IntervalBinningBaseV2.
...
class KMeansBinningV2(IntervalBinningBaseV2):
    """K-means clustering-based binning implementation using V2 architecture.
