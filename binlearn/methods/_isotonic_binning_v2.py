"""
Clean Isotonic binning implementation for V2 architecture.

This module provides IsotonicBinningV2 that inherits from SupervisedBinningBaseV2.
...
class IsotonicBinningV2(SupervisedBinningBaseV2):
    """Isotonic regression-based monotonic binning implementation using V2 architecture.
