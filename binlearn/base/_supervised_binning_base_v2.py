...
This module provides supervised binning functionality that inherits from IntervalBinningBaseV2.
...
from ..utils.errors import ConfigurationError, ValidationError, DataQualityWarning
from ..utils.types import BinEdgesDict, ColumnList
from ..utils import (
...
class SupervisedBinningBaseV2(IntervalBinningBaseV2):
    """Supervised binning functionality inheriting from IntervalBinningBaseV2.
