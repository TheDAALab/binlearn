...
def check_function_usage(function_name):
    ...
    result = subprocess.run(
        ['grep', '-r', '--include=*.py', function_name, '/home/gykovacs/workspaces/binlearn/binlearn/'],
    ...
    usage_lines = []
    for line in lines:
        if line and 'def ' + function_name not in line and '__all__' not in line and 'from .' not in line:
