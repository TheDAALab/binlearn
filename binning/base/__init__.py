...
__all__ = [
    ...
    # Flexible binning utilities
    'FlexibleBinSpec', 'FlexibleBinReps', 'ensure_flexible_bin_spec',
    'generate_default_flexible_representatives', 'validate_flexible_bins',
    'is_missing_value', 'find_flexible_bin_for_value', 'calculate_flexible_bin_width',
    'transform_value_to_flexible_bin', 'get_flexible_bin_count', 'validate_single_flexible_bin_def',
