...
from ..errors import (
    ...
    FittingError, DataQualityWarning, validate_tree_params
)
...
class SupervisedBinningBase(IntervalBinningBase):
    ...
    def require_guidance_data(self, guidance_data: Optional[np.ndarray], method_name: str = "supervised binning") -> None:
        """
